...
class StudentRegistration(forms.Form):
    ...
    roll = forms.IntegerField(min_value=5, max_value=40, error_messages={'required':'Enter Your Roll'})
    price = forms.DecimalField(min_value=5, max_value=40, max_digits=4, decimal_places=1, error_messages={'required':'Enter Your Price'})
    rate = forms.FloatField(min_value=5, max_value=40, error_messages={'required':'Enter Own Rate'})
